...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { campus_id: @classroom.campus_id, capacity: @classroom.capacity, name: @classroom.name }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { campus_id: @classroom.campus_id, capacity: @classroom.capacity, name: @classroom.name }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
